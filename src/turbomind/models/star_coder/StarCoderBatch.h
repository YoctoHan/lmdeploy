...
public:
    ...
    explicit StarCoderBatch(int max_batch_size, int max_context_token_num, int session_len, StarCoder<T>* star_coder);
...
private:
    ...
    using CachedSeq = StarCoderCacheManager::Sequence;
