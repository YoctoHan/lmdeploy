...
template<typename T>
void StarCoderDecoderSelfAttentionLayer<T>::allocateBuffer(size_t batch_size, int key_len, int max_memory_len)
{
...
template<typename T>
void StarCoderDecoderSelfAttentionLayer<T>::freeBuffer()
{
...
template<typename T>
void StarCoderDecoderSelfAttentionLayer<T>::forward(TensorMap*                     output_tensors,
...
template class StarCoderDecoderSelfAttentionLayer<float>;
template class StarCoderDecoderSelfAttentionLayer<half>;
