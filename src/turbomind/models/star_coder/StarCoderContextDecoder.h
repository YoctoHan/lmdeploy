...
template<typename T>
class StarCoderContextDecoder: public BaseLayer {
protected:
    void allocateBuffer() override;
    void allocateBuffer(size_t batch_size, size_t num_token, size_t max_q_len, size_t max_kv_len);
    void freeBuffer() override;

    void initialize(const StarCoderAttentionParams& attn_params, size_t kv_head_num, bool use_fmha, int quant_policy);
...
public:
    StarCoderContextDecoder(size_t                      head_num,
                        size_t                      kv_head_num,
