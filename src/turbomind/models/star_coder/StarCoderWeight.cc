...
template<typename T>
StarCoderWeight<T>::StarCoderWeight(size_t     head_num,
                                    size_t     kv_head_num,
    ...
    tensor_para_rank_(tensor_para_rank)
{
    ...
    for (unsigned l = 0; l < num_layer_; ++l) {
        decoder_layer_weights.push_back(new StarCoderDecoderLayerWeight<T>(head_num,
                                                                           kv_head_num,
                                                                           size_per_head,
                                                                           inter_size_,
                                                                           weight_type_,
...
template<typename T>
void StarCoderWeight<T>::loadModel(std::string dir_path)
{
