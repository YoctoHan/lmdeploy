...
public:
    StarCoderDecoderLayerWeight() = delete;
    StarCoderDecoderLayerWeight(size_t     head_num,
                                size_t     kv_head_num,
    ...
    StarCoderDecoderLayerWeight(const StarCoderDecoderLayerWeight& other) = delete;
    StarCoderDecoderLayerWeight& operator=(const StarCoderDecoderLayerWeight& other) = delete;

    void loadModel(std::string dir_path, FtCudaDataType model_file_type);

    T*                          pre_self_attn_norm_weights{};
    T*                          pre_self_attn_norm_bias{};
    StarCoderAttentionWeight<T> self_attn_weights{};
    StarCoderFfnWeight<T>       ffn_weights{};
