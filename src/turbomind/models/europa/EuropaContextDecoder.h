...
#include "src/turbomind/models/europa/EuropaContextAttentionLayer.h"
...
template<typename T>
class EuropaContextDecoder: public BaseLayer {
protected:
    void allocateBuffer() override;
    void allocateBuffer(size_t batch_size, size_t num_token, size_t max_q_len, size_t max_kv_len);
    void freeBuffer() override;

    void initialize(const EuropaAttentionParams& attn_params, size_t kv_head_num, bool use_fmha, int quant_policy);
    ...
    EuropaContextAttentionLayer<T>* context_attention_layer_{};
...
public:
    EuropaContextDecoder(size_t                      head_num,
                        size_t                      kv_head_num,
