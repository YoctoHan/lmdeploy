...
template<typename T>
void EuropaContextAttentionLayer<T>::allocateBuffer(size_t batch_size,
                                                   size_t num_token,
                                                   size_t max_q_len,
                                                   size_t max_k_len)
{
...
template<typename T>
void EuropaContextAttentionLayer<T>::freeBuffer()
{
...
template<typename T>
inline void EuropaContextAttentionLayer<T>::forward(TensorMap*                     output_tensors,
...
template<typename T>
void EuropaContextAttentionLayer<T>::unfusedMultiHeadAttention(T**          key_cache_ptrs,
                                                              T**          val_cache_ptrs,
                                                              size_t       cache_layer_offset,
...
template class EuropaContextAttentionLayer<float>;
template class EuropaContextAttentionLayer<half>;
