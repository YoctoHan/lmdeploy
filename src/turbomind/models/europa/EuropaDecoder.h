...
template<typename T>
class EuropaDecoder: public BaseLayer {
protected:
    void allocateBuffer() override;  // deprecated
    void allocateBuffer(size_t batch_size);
    void freeBuffer() override;
    void initialize(const EuropaAttentionParams& attn_params, size_t kv_head_num, int quant_policy);
    ...
    EuropaDecoderSelfAttentionLayer<T>* self_attention_layer_{};
    EuropaFfnLayer<T>*                  gelu_ffn_layer_{};
    ...
    struct Session {
        ...
        Tensor*                                         k_cache;
        Tensor*                                         v_cache;
        const std::vector<EuropaDecoderLayerWeight<T>*>* weights;
    };
    ...
    void forwardFfn(const EuropaDecoder::Session& sess, T* ffn_io, size_t layer);

public:
    EuropaDecoder(size_t                      head_num,
                 size_t                      kv_head_num,
