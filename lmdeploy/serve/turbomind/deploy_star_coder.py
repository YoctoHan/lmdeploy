...
supported_formats = ['llama', 'hf', 'awq', 'qwen', 'star_coder']
...
def export(model_name: str,
    ...
    attn_bias = False
    # inter_size = 0
    # star_coder 模型不需要这个参数，所以做了隔离
    inter_size = 1

    tok_embeddings = model_params['word_embeddings.weight']
